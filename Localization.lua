...
combatTextNowEnabledMessage = {
    ...
    ruRU = "|cFFFFFF00Плавающий Боевой Текста|r был |cFFF00000Отключен|r но теперь |c000FFF00Включен|r!",
    koKR = "|cFFFFFF00부유하는 전투 텍스트|r 가 |cFFF00000비활성화되었으나|r 이제 |c000FFF00활성화됐습니다|r!",
    zhTW = "|cFFFFFF00浮動戰鬥文|r本已|cFFF00000禁用|r，但現在已|c000FFF00啟用|r！",
    zhCN = "|cFFFFFF00浮动战斗文|r本已|cFFF00000禁用|r，但现在已|c000FFF00启用|r！"
}
combatTextIsEnabledMessage = {
    enUS = "|cFFFFFF00Floating Combat Text|r is |c000FFF00Enabled|r.",
    esMX = "El |cFFFFFF00Texto de Combate Flotante|r está |c000FFF00Habilitado|r.",
    ...
    ruRU = "|cFFFFFF00Плавающий Боевой Текста|r есть |c000FFF00Включен|r.",
    koKR = "|cFFFFFF00부유하는 전투 텍스트가|r |c000FFF00활성화되었습니다|r.",
    zhTW = "|cFFFFFF00浮動戰鬥文|r本被|c000FFF00啟用|r.",
    zhCN = "|cFFFFFF00浮动战斗文|r本被|c000FFF00启用|r."
}
combatTextIsDisabledMessage = {
    enUS = "|cFFFFFF00Floating Combat Text|r is |cFFF00000Disabled|r.",
    esMX = "El |cFFFFFF00Texto de Combate Flotante|r está |cFFF00000Deshabilitado|r.",
    ...
    ruRU = "|cFFFFFF00Плавающий Боевой Текста|r есть |cFFF00000Отключен|r.",
    koKR = "|cFFFFFF00부유하는 전투 텍스트가|r |cFFF00000비활성화되었으나|r.",
